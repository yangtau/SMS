...
(function dartProgram() {
  ...
  Y = {
    main: function() {
      var t1, table, i, row;
      t1 = document;
      H.printString(H.S(t1.cookie));
      table = H.interceptedTypeCheck(t1.querySelector("#students-table"), "$isTableElement");
      for (i = 0; i < 20; ++i) {
        row = table.insertRow(-1);
        H.interceptedTypeCheck(row.insertCell(0), "$isTableCellElement").textContent = "12345";
        H.interceptedTypeCheck(row.insertCell(1), "$isTableCellElement").textContent = "Tau";
        H.interceptedTypeCheck(row.insertCell(2), "$isTableCellElement").textContent = "yangtao@tau.com";
        H.interceptedTypeCheck(row.insertCell(3), "$isTableCellElement").textContent = "15181602870";
      }
    }
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.FormElement, W.SelectElement, W.TableCellElement, W.TableElement]);
  })();
  (function constants() {
...
;
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, args: [,]}, {func: 1, args: [P.String]}], interceptorsByTag: null, leafTags: null};
